...
class SQLSettingPublisher extends AbstractPublisher implements SettingPublisher {
    ...
    @Inject
    public SQLSettingPublisher(ListeningExecutorService service, SQLQueries queries, GroupProvider groupProvider) {
...
//            Group group = groupProvider.getGroup(subject.getUUID()).get();
