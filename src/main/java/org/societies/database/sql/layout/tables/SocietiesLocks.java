...
public class SocietiesLocks extends org.jooq.impl.TableImpl<org.societies.database.sql.layout.tables.records.SocietiesLocksRecord> {
     ...
     */
    public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.SocietiesLocksRecord, java.lang.Short> ID = createField("id", org.jooq.impl.SQLDataType.SMALLINT
            .nullable(false), this, "");
    ...
    public java.util.List<org.jooq.UniqueKey<org.societies.database.sql.layout.tables.records.SocietiesLocksRecord>> getKeys() {
        return java.util.Arrays
                .<org.jooq.UniqueKey<org.societies.database.sql.layout.tables.records.SocietiesLocksRecord>>asList(org.societies.database.sql.layout.Keys.KEY_SOCIETIES_LOCKS_PRIMARY, org.societies.database.sql.layout.Keys.KEY_SOCIETIES_LOCKS_ID_UNIQUE);
    }
