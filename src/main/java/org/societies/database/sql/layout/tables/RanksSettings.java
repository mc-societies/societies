...
public class RanksSettings extends org.jooq.impl.TableImpl<org.societies.database.sql.layout.tables.records.RanksSettingsRecord> {
	 ...
	 */
	public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.RanksSettingsRecord, byte[]> SUBJECT_UUID = createField("subject_uuid", org.jooq.impl.SQLDataType.VARBINARY.length(16).nullable(false), this, "");

	/**
	 * The column <code>societies.ranks_settings.target_uuid</code>.
	 */
	public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.RanksSettingsRecord, byte[]> TARGET_UUID = createField("target_uuid", org.jooq.impl.SQLDataType.VARBINARY.length(16).nullable(false), this, "");
