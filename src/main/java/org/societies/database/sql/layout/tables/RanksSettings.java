...
public class RanksSettings extends org.jooq.impl.TableImpl<org.societies.database.sql.layout.tables.records.RanksSettingsRecord> {
	...
	private static final long serialVersionUID = 574131501;

	/**
	 * The reference instance of <code>societies.ranks_settings</code>
	 */
	 ...
	 */
	public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.RanksSettingsRecord, java.util.UUID> SUBJECT_UUID = createField("subject_uuid", org.jooq.impl.SQLDataType.VARBINARY.length(16).nullable(false), this, "", new org.societies.database.sql.UUIDConverter());

	/**
	 * The column <code>societies.ranks_settings.target_uuid</code>.
	 */
	public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.RanksSettingsRecord, java.util.UUID> TARGET_UUID = createField("target_uuid", org.jooq.impl.SQLDataType.VARBINARY.length(16).nullable(false), this, "", new org.societies.database.sql.UUIDConverter());

	/**
	 * The column <code>societies.ranks_settings.setting</code>.
	 */
	public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.RanksSettingsRecord, org.jooq.types.UShort> SETTING = createField("setting", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");

	/**
	 * The column <code>societies.ranks_settings.value</code>.
	 */
	public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.RanksSettingsRecord, byte[]> VALUE = createField("value", org.jooq.impl.SQLDataType.VARBINARY.length(64), this, "");
	...
	public java.util.List<org.jooq.UniqueKey<org.societies.database.sql.layout.tables.records.RanksSettingsRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.societies.database.sql.layout.tables.records.RanksSettingsRecord>>asList(org.societies.database.sql.layout.Keys.KEY_RANKS_SETTINGS_PRIMARY);
	}
	...
	public java.util.List<org.jooq.ForeignKey<org.societies.database.sql.layout.tables.records.RanksSettingsRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.societies.database.sql.layout.tables.records.RanksSettingsRecord, ?>>asList(org.societies.database.sql.layout.Keys.FK_RANKS_SETTINGS_RANKS1, org.societies.database.sql.layout.Keys.FK_RANKS_SETTINGS_RANKS2);
	}
