...
public class SocietiesSettingsRecord extends org.jooq.impl.UpdatableRecordImpl<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord> implements org.jooq.Record4<java.util.UUID, java.util.UUID, org.jooq.types.UShort, byte[]> {

	private static final long serialVersionUID = -515512650;
	 ...
	 */
	@Override
	public org.jooq.Record3<java.util.UUID, org.jooq.types.UShort, java.util.UUID> key() {
	 ...
	 */
	@Override
	public SocietiesSettingsRecord value1(java.util.UUID value) {
	 ...
	 */
	@Override
	public SocietiesSettingsRecord value2(java.util.UUID value) {
		setTargetUuid(value);
		return this;
	}
	 ...
	 */
	@Override
	public SocietiesSettingsRecord values(java.util.UUID value1, java.util.UUID value2, org.jooq.types.UShort value3, byte[] value4) {
		return this;
	}
	 ...
	 */
	public SocietiesSettingsRecord(java.util.UUID subjectUuid, java.util.UUID targetUuid, org.jooq.types.UShort setting, byte[] value) {
		super(org.societies.database.sql.layout.tables.SocietiesSettings.SOCIETIES_SETTINGS);
