...
public class SocietiesSettings extends org.jooq.impl.TableImpl<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord> {
     ...
     */
    public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord, byte[]> SUBJECT_UUID = createField("subject_uuid", org.jooq.impl.SQLDataType.VARBINARY
            .length(16).nullable(false), this, "");

    /**
     * The column <code>societies.societies_settings.target_uuid</code>.
     */
    public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord, byte[]> TARGET_UUID = createField("target_uuid", org.jooq.impl.SQLDataType.VARBINARY
            .length(16).nullable(false), this, "");

    /**
     * The column <code>societies.societies_settings.setting</code>.
     */
    public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord, org.jooq.types.UShort> SETTING = createField("setting", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED
            .nullable(false), this, "");

    /**
     * The column <code>societies.societies_settings.value</code>.
     */
    public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord, byte[]> VALUE = createField("value", org.jooq.impl.SQLDataType.VARBINARY
            .length(64), this, "");
    ...
    public java.util.List<org.jooq.UniqueKey<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord>> getKeys() {
        return java.util.Arrays
                .<org.jooq.UniqueKey<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord>>asList(org.societies.database.sql.layout.Keys.KEY_SOCIETIES_SETTINGS_PRIMARY);
    }
    ...
    public java.util.List<org.jooq.ForeignKey<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord, ?>> getReferences() {
        return java.util.Arrays
                .<org.jooq.ForeignKey<org.societies.database.sql.layout.tables.records.SocietiesSettingsRecord, ?>>asList(org.societies.database.sql.layout.Keys.FK_SOCIEITES_SETTINGS_SOCIETIES1, org.societies.database.sql.layout.Keys.FK_SOCIETIES_SETTINGS_SOCIETIES1);
    }
