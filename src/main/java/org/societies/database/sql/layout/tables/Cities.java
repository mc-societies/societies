...
public class Cities extends org.jooq.impl.TableImpl<org.societies.database.sql.layout.tables.records.CitiesRecord> {
	...
	private static final long serialVersionUID = 248128932;

	/**
	 * The singleton instance of <code>societies.cities</code>
	 */
	 ...
	 */
	public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.CitiesRecord, byte[]> UUID = createField("uuid", org.jooq.impl.SQLDataType.VARBINARY.length(16).nullable(false), this, "");

	/**
	 * The column <code>societies.cities.society</code>.
	 */
	public final org.jooq.TableField<org.societies.database.sql.layout.tables.records.CitiesRecord, byte[]> SOCIETY = createField("society", org.jooq.impl.SQLDataType.VARBINARY.length(16).nullable(false), this, "");
