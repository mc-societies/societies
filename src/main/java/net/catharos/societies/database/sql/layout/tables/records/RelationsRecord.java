...
public class RelationsRecord extends org.jooq.impl.UpdatableRecordImpl<net.catharos.societies.database.sql.layout.tables.records.RelationsRecord> implements org.jooq.Record3<byte[], byte[], java.lang.Short> {

	private static final long serialVersionUID = 1328441134;
	...
	public org.jooq.Field<byte[]> field1() {
		return net.catharos.societies.database.sql.layout.tables.Relations.RELATIONS.SOCIETY;
	}
	...
	public org.jooq.Field<byte[]> field2() {
		return net.catharos.societies.database.sql.layout.tables.Relations.RELATIONS.SOCIETY2;
	}
	...
	public org.jooq.Field<java.lang.Short> field3() {
		return net.catharos.societies.database.sql.layout.tables.Relations.RELATIONS.TYPE;
	}
	...
	public RelationsRecord() {
		super(net.catharos.societies.database.sql.layout.tables.Relations.RELATIONS);
	}
