...
public class SocietiesSettingsRecord extends org.jooq.impl.UpdatableRecordImpl<net.catharos.societies.database.sql.layout.tables.records.SocietiesSettingsRecord> implements org.jooq.Record4<byte[], byte[], org.jooq.types.UShort, byte[]> {

	private static final long serialVersionUID = -496845191;
	...
	public org.jooq.Field<byte[]> field1() {
		return net.catharos.societies.database.sql.layout.tables.SocietiesSettings.SOCIETIES_SETTINGS.SUBJECT_UUID;
	}
	...
	public org.jooq.Field<byte[]> field2() {
		return net.catharos.societies.database.sql.layout.tables.SocietiesSettings.SOCIETIES_SETTINGS.TARGET_UUID;
	}
	...
	public org.jooq.Field<org.jooq.types.UShort> field3() {
		return net.catharos.societies.database.sql.layout.tables.SocietiesSettings.SOCIETIES_SETTINGS.SETTING;
	}
	...
	public org.jooq.Field<byte[]> field4() {
		return net.catharos.societies.database.sql.layout.tables.SocietiesSettings.SOCIETIES_SETTINGS.VALUE;
	}
	...
	public SocietiesSettingsRecord() {
		super(net.catharos.societies.database.sql.layout.tables.SocietiesSettings.SOCIETIES_SETTINGS);
	}
