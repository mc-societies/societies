...
public class Relations extends org.jooq.impl.TableImpl<net.catharos.societies.database.layout.tables.records.RelationsRecord> {
	...
	private static final long serialVersionUID = 618797961;
	...
	public Relations(java.lang.String alias) {
		this(alias, net.catharos.societies.database.layout.tables.Relations.RELATIONS);
	}

	private Relations(java.lang.String alias, org.jooq.Table<net.catharos.societies.database.layout.tables.records.RelationsRecord> aliased) {
		this(alias, aliased, null);
	}

	private Relations(java.lang.String alias, org.jooq.Table<net.catharos.societies.database.layout.tables.records.RelationsRecord> aliased, org.jooq.Field<?>[] parameters) {
	...
	public net.catharos.societies.database.layout.tables.Relations as(java.lang.String alias) {
		return new net.catharos.societies.database.layout.tables.Relations(alias, this);
	}

	/**
	 * Rename this table
	 */
	public net.catharos.societies.database.layout.tables.Relations rename(java.lang.String name) {
		return new net.catharos.societies.database.layout.tables.Relations(name, null);
	}
}
