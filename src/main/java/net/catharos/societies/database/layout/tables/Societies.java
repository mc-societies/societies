...
public class Societies extends org.jooq.impl.TableImpl<net.catharos.societies.database.layout.tables.records.SocietiesRecord> {
	...
	private static final long serialVersionUID = -1971852150;
	 ...
	 */
	public final org.jooq.TableField<net.catharos.societies.database.layout.tables.records.SocietiesRecord, java.lang.String> TAG = createField("tag", org.jooq.impl.SQLDataType.VARCHAR.length(45), this);
	 ...
	 */
	public final org.jooq.TableField<net.catharos.societies.database.layout.tables.records.SocietiesRecord, java.lang.Short> STATE = createField("state", org.jooq.impl.SQLDataType.SMALLINT, this);

	/**
	 * Create a <code>societies.societies</code> table reference
	 */
	public Societies() {
		super("societies", net.catharos.societies.database.layout.Societies.SOCIETIES);
	}
	...
	public Societies(java.lang.String alias) {
		super(alias, net.catharos.societies.database.layout.Societies.SOCIETIES, net.catharos.societies.database.layout.tables.Societies.SOCIETIES);
	}
	...
	public net.catharos.societies.database.layout.tables.Societies as(java.lang.String alias) {
		return new net.catharos.societies.database.layout.tables.Societies(alias);
	}
}
