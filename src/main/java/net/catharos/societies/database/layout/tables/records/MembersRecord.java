...
public class MembersRecord extends org.jooq.impl.UpdatableRecordImpl<net.catharos.societies.database.layout.tables.records.MembersRecord> implements org.jooq.Record4<byte[], java.sql.Timestamp, java.lang.Short, byte[]> {

	private static final long serialVersionUID = 2006556171;
	 ...
	 */
	@Override
	public org.jooq.Row4<byte[], java.sql.Timestamp, java.lang.Short, byte[]> fieldsRow() {
	 ...
	 */
	@Override
	public org.jooq.Row4<byte[], java.sql.Timestamp, java.lang.Short, byte[]> valuesRow() {
	 ...
	 */
	@Override
	public MembersRecord values(byte[] value1, java.sql.Timestamp value2, java.lang.Short value3, byte[] value4) {
		return this;
	}
	 ...
	 */
	public MembersRecord(byte[] uuid, java.sql.Timestamp created, java.lang.Short state, byte[] society) {
		super(net.catharos.societies.database.layout.tables.Members.MEMBERS);
