...
public class RanksSettingsRecord extends org.jooq.impl.UpdatableRecordImpl<net.catharos.societies.database.layout.tables.records.RanksSettingsRecord> implements org.jooq.Record4<byte[], byte[], org.jooq.types.UShort, byte[]> {

	private static final long serialVersionUID = 1545464316;
