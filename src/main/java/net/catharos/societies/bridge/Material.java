...
public enum Material {
    ...
    private final static TIntObjectHashMap<Material> BY_ID = new TIntObjectHashMap<Material>();
    private final static Map<String, Material> BY_NAME = new THashMap<String, Material>();
